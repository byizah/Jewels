...
function toggleSidebar() {
  ...
  const products = [
    ...
    {id: 313, name: 'Hidden Love Pendant Necklace', price:229, images: ['assets/images/hiddenlovependant.JPG','assets/images/hiddenlovependant1.JPG','assets/images/hiddenlovependant2.JPG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'A gold-tone beaded necklace with a round white pendant featuring a small, hidden heart cut-out. '},
    {id: 314, name: 'Golden rose pendant Necklace', price:229, images: ['assets/images/goldenrose.JPG','assets/images/goldenrose1.JPG','assets/images/goldenrose2.JPG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'A gold-tone necklace with a round, mother-of-pearl pendant featuring a gold rose design '},
    ...
    {id: 316, name: '11:11 love necklace', price:199, images: ['assets/images/1111lovenecklace.jpg','assets/images/1111lovenecklace1.jpg','assets/images/11 neck 3.JPG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'A gold-tone chain necklace with a small heart-shaped pendant engraved with "11:11".'},
    ...
    {id: 319, name: 'Olive recta pendant necklace', price:199, images: ['assets/images/oliverectapendant.jpg','assets/images/oliverectapendant1.jpg','assets/images/olive recta.PNG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'Gold-tone necklace with a dark square-cut gemstone pendant.'},
    {id: 320, name: 'Blue lotus pendant necklace', price:199, images: ['assets/images/bluelotuspendant.jpg','assets/images/bluelotuspendant1.jpg','assets/images/bluelotuspendent.PNG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'Gold-tone necklace with a square floral pendant and pearl detail.'},
    ...
    {id: 322, name: 'Golden flower necklace', price:199, images: ['assets/images/goldenflowernecklace.jpg','assets/images/goldenflowernecklace1.jpg','assets/images/golden flower.PNG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'Gold-tone floral pendant necklace with a subtle crystal accent.'},
    {id: 323, name: 'Lavender recta necklace', price:199, images: ['assets/images/lavenderrectanecklace.jpg','assets/images/lavenderrectanecklace1.jpg','assets/images/lavender recta.PNG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'Gold-tone necklace with a square-cut crystal pendant.'},
    ...
    {id: 327, name: 'Heart Pendant necklace', price:199, images: ['assets/images/heart pendant 1.jpeg','assets/images/heart pendant 2.jpeg','assets/images/heart pendant 3.jpeg'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'Gold-tone heart pendant necklace with a sleek, minimal finish.'}
