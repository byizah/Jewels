...
function toggleSidebar() {
  ...
  const products = [
    ...
    {id: 314, name: 'Golden rose  Necklace', price:229, images: ['assets/images/goldenrose.JPG','assets/images/goldenrose1.JPG','assets/images/goldenrose2.JPG'], inStock: true, qtyAvailable:1 , category: 'necklaces', description: 'A gold-tone necklace with a round, mother-of-pearl pendant featuring a gold rose design '},
