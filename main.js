...
function toggleSidebar() {
  ...
  const products = [
    ...
    {id: 12, name: 'Blue Aura Necklace', price: 189, images: ['assets/images/BlueAuranecklace.jpg','assets/images/Bowsnakenecklace1.png'], inStock:true, qtyAvailable: 1, category: 'necklaces', description: 'Unique bow design with snake chain. Modern and chic.'},
